...
/* harmony default export */ __webpack_exports__["default"] = ((req, res) => {
  ...
  console.log('.env.local - SITE_PASSWORD:', process.env.SITE_PASSWORD); // console.log('next.config.js - runtimeSecret:', serverRuntimeConfig.runtimeSecret)
  ...
  res.json({
    ...
    secrets: {
      ...
      '.env.local - SITE_PASSWORD:': process.env.SITE_PASSWORD // 'next.config.js - runtimeSecret:': serverRuntimeConfig.runtimeSecret,
